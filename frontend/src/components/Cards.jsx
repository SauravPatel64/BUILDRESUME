...
export const ResumeSummaryCard = ({
  ...
  return (
    <div
      ...
      onClick={onSelect}
      onMouseEnter={() => setIsHovered(true)} //MOUSE OR SWIPE  VIEW
...
//            <div className="absolute inset-0 bg-gradient-to-t from-white/10 via-transparent
...
//               justify-center shadow-lg animate-pluse">
...
//           </div>
//         ) : (
//           <div className=" w-full h-[200px] flex  items-center flex-cols justify-center bg-gradient-to-br from-violet-50
