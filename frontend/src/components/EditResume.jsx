...
const EditResume = () => {
  ...
  //TAKE BACK TO  PREVIOUS FORM STATE OR TAKE BACK TO FIRST
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  //Adding new item if  information
  ...
  //REMOVING FUNCTION  USING ARRAY INFORMATION
  ...
  //FETCHING RESUME USING ID AND ALSO USING BACKEND
  ...
  // IT WILL HELP  IN CHOOSING THE PREVIEW AS WELL  AS HELPS IN DOWNLOADING THE RESUME ALSO SAVE THE RESUME  AS  IMAGE
  ...
  // this function will help in update the resumes and put will help in  updation  on backend..
  ...
  //Download function  help to  download
  ...
  // all the code that i have given is on cans
