...
const Dashboard = () => {
  ...
  const handleDeleteResume = async () => {
    ...
    try {
      ...
      setAllResumes([]);            // reset properly (or remove this line, since you call fetchAllResumes anyway)
      setShowDeleteConfirm(false);  // ✅ use the setter, not the variable
}
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper}>
            ...
            <p className={styles.emptyText}>
              You haven't created amy resumes yet. Start building your
